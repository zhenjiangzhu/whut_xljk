...
{
    public partial class articleList : System.Web.UI.Page, ISingleGridPage
    {
        ...
        {
            return "~/admin/article/articleAdd.aspx";
        }
        ...
        public string GetEditUrl()
        {
            ...
            return String.Format("~/admin/article/articleDetail.aspx?id={0}&name={1}", keys[0], HttpUtility.UrlEncode(keys[1].ToString()));
        }
