                        ...
                        <f:Tree runat="server" ShowBorder="false" ShowHeader="false" EnableArrows="true" EnableLines="true" ID="leftMenuTree">
                            <Nodes>
                                <f:TreeNode Text="默认分类" Expanded="true">
                                    <f:TreeNode Text="开始页面" NavigateUrl="~/admin/hello.aspx"></f:TreeNode>
                                    <f:TreeNode Text="登录页面" NavigateUrl="~/admin/login.aspx"></f:TreeNode>
                                </f:TreeNode>
                                 <f:TreeNode Text="新闻管理" Expanded="true" >
                                    <f:TreeNode Text="文章管理" NavigateUrl="~/admin/article/articleList.aspx"></f:TreeNode>
                                    <f:TreeNode Text="文件管理" NavigateUrl="~/admin/file/fileList.aspx"></f:TreeNode>
                                     <f:TreeNode Text="首页大图" NavigateUrl="~/admin/imgchange/imgChange.aspx"></f:TreeNode>
                                </f:TreeNode>
                                <f:TreeNode Text="在线问答管理" Expanded="true" >
                                    <f:TreeNode Text="未回复问答" NavigateUrl="~/admin/message/messageNotHandled.aspx"></f:TreeNode>
                                    <f:TreeNode Text="已回复问答管理" NavigateUrl="~/admin/message/messageReplied.aspx"></f:TreeNode>
                                </f:TreeNode>
                                <f:TreeNode Text="咨询预约管理" Expanded="true" >
                                    <f:TreeNode Text="修改值班表" NavigateUrl="~/admin/appointment/schedule.aspx"></f:TreeNode>
                                    <f:TreeNode Text="预约审核状态" NavigateUrl="~/admin/appointment/messageReplied.aspx"></f:TreeNode>
                                </f:TreeNode>
                            </Nodes>
                        </f:Tree>
                    </Items>
